...
public class JsoniterReader implements JsonReader {
    ...
    public JsonStructure read() {
        checkState();
        return (JsonStructure) JsoniterStructure.jsonValueOf(this.any);
    }

    @Override
    public JsonObject readObject() {
        checkState();
        return (JsonObject) JsoniterStructure.jsonValueOf(this.any);
    }

    @Override
    public JsonArray readArray() {
        checkState();
        return (JsonArray) JsoniterStructure.jsonValueOf(this.any);
    }
