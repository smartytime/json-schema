...
public class JsonSchemaValidator implements SchemaValidator {
    ...
    public JsonSchemaValidator(KeywordValidatorCreators factories, Schema schema, SchemaValidatorFactoryImpl validatorFactory) {
    ...
    /**
     * Executes this validation for the provided {@code subject} and appends any errors to the provided {@code parentReport}
     ...
     */
    @Nullable
    List<KeywordValidator> findValidators(JsonValueWithPath subject) {
