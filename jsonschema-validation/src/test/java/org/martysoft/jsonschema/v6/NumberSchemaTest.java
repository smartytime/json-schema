...
import org.martysoft.jsonschema.loader.SchemaLoader;
...
public class NumberSchemaTest {
    ...
    public void exclusiveMinimum() {
        NumberSchema subject = TestSupport.buildWithLocation(NumberSchema.builder().minimum(10.0).exclusiveMinimum(true));
    ...
    @Test
    public void maximum() {
        NumberSchema subject = TestSupport.buildWithLocation(NumberSchema.builder().maximum(20.0));
        TestSupport.failureOf(subject)
    ...
    public void exclusiveMaximum() {
        NumberSchema subject = TestSupport.buildWithLocation(NumberSchema.builder().maximum(20.0).exclusiveMaximum(true));
        TestSupport.failureOf(subject)
    ...
    public void minimumFailure() {
        NumberSchema subject = TestSupport.buildWithLocation(NumberSchema.builder().minimum(10.0));
        TestSupport.failureOf(subject)
    ...
    public void multipleOfFailure() {
        NumberSchema subject = TestSupport.buildWithLocation(NumberSchema.builder().multipleOf(10));
        TestSupport.failureOf(subject)
    ...
    public void requiresIntegerFailure() {
        NumberSchema subject = TestSupport.buildWithLocation(NumberSchema.builder().requiresInteger(true));
