...
public class StringSchemaTest {
    ...
    public void formatFailure() {
        StringSchema subject = TestSupport.buildWithLocation(StringSchema.builder()
    ...
    public void maxLength() {
        StringSchema subject = TestSupport.buildWithLocation(StringSchema.builder().maxLength(3));
        TestSupport.failureOf(subject)
    ...
    public void minLength() {
        StringSchema subject = TestSupport.buildWithLocation(StringSchema.builder().minLength(2));
        TestSupport.failureOf(subject)
    ...
    public void patternFailure() {
        StringSchema subject = TestSupport.buildWithLocation(StringSchema.builder().pattern("^a*$"));
