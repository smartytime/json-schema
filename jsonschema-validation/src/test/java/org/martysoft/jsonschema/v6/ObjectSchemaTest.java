...
public class ObjectSchemaTest {
    ...
    public void additionalPropertySchema() {
        ...
        ObjectSchema subject = TestSupport.buildWithLocation(ObjectSchema.builder()
    ...
    public void maxPropertiesFailure() {
        ObjectSchema subject = TestSupport.buildWithLocation(ObjectSchema.builder().maxProperties(2));
        TestSupport.failureOf(subject)
    ...
    public void minPropertiesFailure() {
        ObjectSchema subject = TestSupport.buildWithLocation(ObjectSchema.builder().minProperties(2));
        TestSupport.failureOf(subject)
    ...
    public void multipleAdditionalProperties() {
        ObjectSchema subject = TestSupport.buildWithLocation(ObjectSchema.builder().additionalProperties(false));
        try {
    ...
    public void propertyDepViolation() {
        ObjectSchema subject = TestSupport.buildWithLocation(
                ObjectSchema.builder()
    ...
    public void requireObject() {
        TestSupport.expectFailure(TestSupport.buildWithLocation(ObjectSchema.builder()), "#", "foo");
    }
