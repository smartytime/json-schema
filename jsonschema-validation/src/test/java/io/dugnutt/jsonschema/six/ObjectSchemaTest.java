...
public class ObjectSchemaTest {
    ...
    public void additionalPropertySchema() {
        ...
        ValidationTestSupport.failureOf(subject)
                ...
                .expect();
        ValidationTestSupport.expectFailure(subject, "#/foo", OBJECTS.get("additionalPropertySchema"));
    }

    @Test
    public void maxPropertiesFailure() {
        ObjectSchema subject = ValidationTestSupport.buildWithLocation(ObjectSchema.builder().maxProperties(2));
        ValidationTestSupport.failureOf(subject)
    ...
    public void minPropertiesFailure() {
        ObjectSchema subject = ValidationTestSupport.buildWithLocation(ObjectSchema.builder().minProperties(2));
        ValidationTestSupport.failureOf(subject)
    ...
    public void multipleAdditionalProperties() {
        ObjectSchema subject = ValidationTestSupport.buildWithLocation(ObjectSchema.builder().additionalProperties(false));
        try {
    ...
    public void multipleViolations() {
        ...
        try {
            ...
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(e, "#"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(e, "#/numberProp"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(e, "#/stringPatternMatch"));

            List<String> messages = e.getAllMessages();
            assertEquals(3, messages.size());
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#:"));
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/numberProp:"));
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/stringPatternMatch:"));
        }
    }
    ...
    public void multipleViolationsNested() throws Exception {
        ...
        try {
            ...
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(subjectException, "#"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(subjectException, "#/numberProp"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(subjectException, "#/stringPatternMatch"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(subjectException, "#/nested"));
            ...
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(nested1Exception, "#/nested"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(nested1Exception, "#/nested/numberProp"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(nested1Exception, "#/nested/stringPatternMatch"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(nested1Exception, "#/nested/nested"));
            ...
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(nested2Exception, "#/nested/nested"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(nested2Exception, "#/nested/nested/numberProp"));
            assertEquals(1, ValidationTestSupport.countCauseByJsonPointer(nested2Exception, "#/nested/nested/stringPatternMatch"));
            ...
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/numberProp:"));
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/stringPatternMatch:"));
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/nested:"));
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/nested/numberProp:"));
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/nested/stringPatternMatch:"));
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/nested/nested:"));
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/nested/nested/numberProp:"));
            assertEquals(1, ValidationTestSupport.countMatchingMessage(messages, "#/nested/nested/stringPatternMatch:"));
        }
    }
    ...
    public void noAdditionalProperties() {
        ...
        ValidationTestSupport.expectFailure(subject, "#", OBJECTS.get("propertySchemaViolation"));
    }
    ...
    public void patternPropertyViolation() {
        ObjectSchema subject = ObjectSchema.builder()
                ...
                .build();
        ValidationTestSupport.expectFailure(subject, BooleanSchema.INSTANCE, "#/b_1",
    ...
    public void propertyDepViolation() {
        ObjectSchema subject = ValidationTestSupport.buildWithLocation(
                ObjectSchema.builder()
    ...
    public void propertySchemaViolation() {
        ...
        ValidationTestSupport.expectFailure(subject, BooleanSchema.INSTANCE, "#/boolProp",
    ...
    public void requireObject() {
        ValidationTestSupport.expectFailure(ValidationTestSupport.buildWithLocation(ObjectSchema.builder()), "#", "foo");
    }
    ...
    public void schemaDepViolation() {
        ...
        ObjectSchema subject = ObjectSchema.builder()
                ...
                .schemaDependency("credit_card", ObjectSchema.builder()
                        ...
                        .build())
                .build();
        ValidationTestSupport.expectFailure(subject, billingAddressSchema, "#/billing_address",
    ...
    public void typeFailure() {
        ValidationTestSupport.failureOf(ObjectSchema.builder())
