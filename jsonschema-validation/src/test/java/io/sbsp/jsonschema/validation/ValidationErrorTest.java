...
public class ValidationErrorTest {
    ...
    private ResourceLoader loader = ResourceLoader.resourceLoader();
    private final Schema rootSchema = schemaBuilder().build();
    ...
    public void testToJson() {
        ...
        JsonObject expected = loader.readJsonObject("exception-to-json.json");
    ...
    public void testToJsonWithSchemaLocation() {
        ...
        JsonObject expected = loader.readJsonObject("exception-to-json-with-schema-location.json");
        JsonObject actual = subject.toJson();
    ...
    public void toJsonWithCauses() {
        ...
        JsonObject expected = loader.readJsonObject("exception-to-json-with-causes.json");
        JsonObject actual = subject.toJson();
        assertEquals(expected, actual);
    }
