...
import static io.sbsp.jsonschema.validation.TestErrorHelper.failure;
...
public class SchemaExceptionTest {
    ...
    private static final Schema NULL_SCHEMA = schemaBuilder().type(NULL).build();
    ...
    public void nullWithMessage() {
        Schema schema = schemaBuilder("#/required/2").type(NULL).build();
