...
import static io.sbsp.jsonschema.validation.ValidationMocks.mockNullSchema;
import static io.sbsp.jsonschema.validation.ValidationMocks.mockNumberSchema;
import static io.sbsp.jsonschema.validation.ValidationMocks.mockObjectSchema;
...
import static io.sbsp.jsonschema.validation.ValidationTestSupport.countCauseByJsonPointer;
import static io.sbsp.jsonschema.validation.ValidationTestSupport.countMatchingMessage;
import static io.sbsp.jsonschema.validation.ValidationTestSupport.expectFailure;
...
public class ObjectKeywordsValidatorTest {
    ...
    private JsonObject objectTestCases;
    @Before
    public void before() {
        objectTestCases= ResourceLoader.resourceLoader().readJsonObject("objecttestcases.json");    
    }
    ...
    public void additionalPropertiesOnEmptyObject() {
        ...
        final JsonObject input = objectTestCases.getJsonObject("emptyObject");
    ...
    public void additionalPropertySchema() {
        SchemaBuilder boolSchema = schemaBuilder().type(BOOLEAN);
        ...
        failureOf(schema)
                ...
                .expected(error -> {
                    ...
                    assertEquals(Keywords.TYPE, cause.getKeyword());
    ...
    public void maxPropertiesFailure() {
        ...
        failureOf(subject)
                .input(objectTestCases.get("maxPropertiesFailure"))
                .expectedPointer("#")
    ...
    public void minPropertiesFailure() {
        ...
        failureOf(subject)
                .input(objectTestCases.get("minPropertiesFailure"))
                .expectedPointer("#")
    ...
    public void multipleAdditionalProperties() {
        ...
        assertEquals(Keywords.ADDITIONAL_PROPERTIES, error.getKeyword());
        assertEquals(2, error.getCauses().size());
    }

    @Test
    public void multipleSchemaDepViolation() {
        SchemaBuilder billingAddressSchema = mockStringSchema();
        SchemaBuilder billingNameSchema = mockStringSchema().minLength(4);
        Schema subject = mockObjectSchema()
        ...
        ValidationError e = verifyFailure(() -> createTestValidator(subject).validate(objectTestCases.get("schemaDepViolation")));
    ...
    public void multipleViolations() {
        ...
        var e = verifyFailure(() -> createTestValidator(subject).validate(objectTestCases.get("multipleViolations")));
    ...
    public void multipleViolationsNested() throws Exception {
        Callable<SchemaBuilder> newBuilder = () -> mockObjectSchema()
                .propertySchema("numberProp", mockNumberSchema())
                .patternProperty("^string.*", mockStringSchema())
                .propertySchema("boolProp", mockBooleanSchema())
                .requiredProperty("boolProp");

        SchemaBuilder nested2 = newBuilder.call();
        SchemaBuilder nested1 = newBuilder.call().propertySchema("nested", nested2);
        Schema subject = newBuilder.call().propertySchema("nested", nested1).build();

        ValidationError subjectException = verifyFailure(() -> createTestValidator(subject).validate(objectTestCases.get("multipleViolationsNested")));
    ...
    public void noProperties() {
        expectSuccess(() -> createTestValidator(mockObjectSchema().build()).validate(objectTestCases.get("noProperties")));
    }
    ...
    public void patternPropertyOverridesAdditionalPropSchema() {
        final Schema schema = mockObjectSchema()
                ...
                .build();
        expectSuccess(() -> createTestValidator(schema).validate(objectTestCases.get("patternPropertyOverridesAdditionalPropSchema")));
    }
    ...
    public void patternPropertyViolation() {
        ...
        expectFailure(subject, mockBooleanSchema().build(), "#/b_1",
                objectTestCases.get("patternPropertyViolation"));
    }
    ...
    public void patternPropsOverrideAdditionalProps() {
        final Schema schema = mockObjectSchema()
                ...
                .build();
        expectSuccess(() -> createTestValidator(schema).validate(objectTestCases.get("patternPropsOverrideAdditionalProps")));
    }
    ...
    public void propertyDepViolation() {
        ...
        failureOf(subject)
                .input(objectTestCases.get("propertyDepViolation"))
    ...
    public void propertyNameSchemaSchemaViolation() {
        final SchemaBuilder propertyNameSchema = mockStringSchema().pattern("^[a-z_]{3,8}$");
        Schema subject = mockObjectSchema()
                .propertyNameSchema(propertyNameSchema)
                .build();
        failureOf(subject)
                .input(objectTestCases.getJsonObject("propertyNameSchemaViolation"))
                .expected(error -> {
    ...
    public void requiredProperties() {
        ...
        failureOf(subject)
                ...
                .input(objectTestCases.get("requiredProperties"))
                .expect();
    }
    ...
    public void schemaDepViolation() {
        ...
        final SchemaBuilder schemaBuilder = mockObjectSchema();
    ...
    public void testImmutability() {
        SchemaBuilder builder = mockObjectSchema();
    ...
    public void toStringNoAdditionalProperties() {
        JsonObject rawSchemaJson = readResourceAsJson("tostring/objectschema.json");
    ...
    public void toStringSchemaDependencies() {
        JsonObject rawSchemaJson = readResourceAsJson("tostring/objectschema-schemadep.json");
        String actual = SchemaLoaderImpl.schemaLoader().readSchema(rawSchemaJson).toString();
        assertEquals(rawSchemaJson, readJsonObject(actual));
    }
    ...
    JsonObject readResourceAsJson(String url) {
        return ResourceLoader.resourceLoader().readJsonObject(url);
    }
}
