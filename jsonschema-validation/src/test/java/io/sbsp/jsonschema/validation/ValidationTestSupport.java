...
public class ValidationTestSupport {
    ...
    public static Schema buildWithLocation(SchemaBuilder builder) {
    ...
    public static Failure failureOf(SchemaBuilder subjectBuilder) {
    ...
    private static Optional<ValidationError> test(final Schema failingSchema, final String expectedPointer,
        ...
        Optional<ValidationError> error = JsonSchemaProvider.getValidator(failingSchema).validate(input);
    ...
    public static class Failure {
        ...
        public Failure expectedKeyword(final KeywordInfo<?> keyword) {
    ...
    public static void expectSuccess(Schema schema, JsonValue input) {
        final Optional<ValidationError> error = JsonSchemaProvider.getValidator(schema).validate(input);
        if (error.isPresent()) {
