...
public class CombinedKeywordValidatorTest {
    ...
    public void reportCauses() {
        final Schema parentSchema = schemaBuilder().allOfSchemas(SUBSCHEMAS).build();
    ...
    public void validateAll() {
        ValidationTestSupport.failureOf(schemaBuilder().allOfSchemas(SUBSCHEMAS).build())
                .input(20)
    ...
    public void validateAny() {
        ValidationTestSupport.failureOf(schemaBuilder().anyOfSchemas(SUBSCHEMAS).build())
                .input(5)
    ...
    public void validateOne() {
        ValidationTestSupport.failureOf(schemaBuilder().oneOfSchemas(SUBSCHEMAS).build())
                .input(30)
