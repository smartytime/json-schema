 ...
 */
package io.sbsp.jsonschema.extractor.reference;

import java.io.InputStream;
import java.net.URI;

/**
 * This interface is used by {@link io.sbsp.jsonschema.extractor.JsonSchemaFactory} to fetch the contents denoted by remote JSON
 * pointer.
