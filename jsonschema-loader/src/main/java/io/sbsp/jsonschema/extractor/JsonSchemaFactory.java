...
import io.sbsp.jsonschema.extractor.reference.SchemaCache;
...
public class JsonSchemaFactory implements SchemaFactory {
    ...
    public Schema loadRootSchema(SchemaLocation location, JsonObject schemaJson) {
        return loadSchema(location, schemaJson, schemaJson, new ExtractionReport());
    }

    public Schema loadSchema(SchemaLocation location, JsonObject schemaJson, JsonObject rootSchemaJson, ExtractionReport report) {
    ...
    public JsonSchemaBuilder createSchemaBuilder(SchemaLocation location, JsonValue schemaJson, JsonObject rootSchemaJson) {
    ...
    public JsonSchemaBuilder createSchemaBuilder(JsonValueWithLocation schemaJson) {
        return createSchemaBuilder(schemaJson, new ExtractionReport());
    }

    public JsonSchemaBuilder createSchemaBuilder(JsonValueWithLocation schemaJson, ExtractionReport report) {
        // ##########################
    ...
    public Schema load(JsonObject schemaJson) {
        ...
        return loadRootSchema(schemaLocation, schemaJson);
    }
