...
import static io.sbsp.jsonschema.TestUtils.createJsonArrayWithLocation;
import static io.sbsp.jsonschema.TestUtils.createJsonNumberWithLocation;
import static io.sbsp.jsonschema.TestUtils.createJsonObjectWithLocation;
...
public class JsonValueWithPathTest {

    private JsonProvider provider = JsonProvider.provider();

    @Test
    public void testEquals() {
        EqualsVerifier.forClass(JsonValueWithPath.class)
    ...
    public void testAsJsonArray_HasValue() {
        final JsonValueWithPath value = createJsonArrayWithLocation();
