...
public enum JsonSchemaKeyword {
    ...
    private final JsonSchemaType appliesTo;
    ...
    JsonSchemaKeyword(boolean appliesToAll) {
        this(appliesToAll, null);
    }

    JsonSchemaKeyword(boolean appliesToAll, JsonSchemaType appliesTo) {
        this.appliesToAll = appliesToAll;
        this.key = CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.LOWER_CAMEL, name());
        this.appliesTo = appliesTo;
    }

    JsonSchemaKeyword(JsonSchemaType appliesTo) {
        this(false, appliesTo);
    }

    public boolean appliesToType(JsonSchemaType type) {
        return appliesTo == type;
    }

    public JsonSchemaType getAppliesToType() {
        return appliesTo;
    }
