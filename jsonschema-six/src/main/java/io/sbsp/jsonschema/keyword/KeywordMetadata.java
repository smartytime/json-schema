...
public class KeywordMetadata<K extends SchemaKeyword> {
    ...
    public static KeywordMetadataBuilder<SchemaMapKeyword> schemaMapKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<SchemaMapKeyword>().key(keyword);
    }

    public static KeywordMetadataBuilder<StringKeyword> stringKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<StringKeyword>().key(keyword);
    }

    public static KeywordMetadataBuilder<JsonValueKeyword> jsonValueKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<JsonValueKeyword>().key(keyword);
    }

    public static KeywordMetadataBuilder<NumberKeyword> numberKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<NumberKeyword>().key(keyword);
    }

    public static KeywordMetadataBuilder<StringSetKeyword> stringSetKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<StringSetKeyword>().key(keyword);
    }

    public static KeywordMetadataBuilder<SingleSchemaKeyword> singleSchemaKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<SingleSchemaKeyword>().key(keyword);
    }

    public static KeywordMetadataBuilder<SchemaListKeyword> schemaListKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<SchemaListKeyword>().key(keyword);
    }

    public static KeywordMetadataBuilder<URIKeyword> uriKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<URIKeyword>().key(keyword);
    }

    public static KeywordMetadataBuilder<BooleanKeyword> booleanKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<BooleanKeyword>().key(keyword);
    }

    public static KeywordMetadataBuilder<JsonArrayKeyword> jsonArrayKeyword(JsonSchemaKeywordType keyword) {
        return new KeywordMetadataBuilder<JsonArrayKeyword>().key(keyword);
    }

    public static <X extends SchemaKeyword> KeywordMetadataBuilder<X> keyword(Class<X> keywordClass) {
